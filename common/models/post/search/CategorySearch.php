...
/**
 * CategorySearch represents the model behind the search form of `common\models\post\Category`.
 */
class CategorySearch extends Category
{
    ...
    {
        $query = Category::find()->asArray()->orderBy('id DESC');
